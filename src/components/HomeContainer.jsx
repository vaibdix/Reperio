...
const HomeContainer = () => {
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full bg-card bg-cover rounded-2xl -m-px-5" id="home">
        
    <div className="py-2 flex-1 flex flex-col items-start  justify-center gap-6 ml-5">
        <div className='flex items-center gap-2 justify-center bg-orange-100 px-4 py-1 rounded-full'>
            <p className='text-base text-orange-500 font-semibold'>
                Bike Trips Sponsered By Bikeroo
            </p>
        ...
        <p className='text-[2rem] lg:text-[3.5rem] font-bold tracking-normal text-headingColor'>
            The Fastest way to leave
            <span className='text-orange-600 text-[3rem] lg:text-[4rem]'> Your City</span>
        </p>

        <p className='text-base text-textColor text-center md:text-left md:w-[80%]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit nostrum perspiciatis velit sunt repellat soluta quidem id a! Perferendis necessitatibus totam saepe quisquam aut explicabo nulla temporibus, corporis deserunt esse!
        </p>
